/*
 * Write an XML file. An adaptation of com.megginson.sax.XMLWriter that allows
 * setting the xml declaration and writing raw data.
 *
 * $Header: /home/ux/CVSROOT/teo/teo/sax/XMLWriter.java,v 1.2 2011/04/07 07:28:32 ux Exp $
 *
...

    ...
    /**
     * Write the given XML declaration at the beginning of the document.
     * teo.sax extension
     */
    public void startDocument(String xmldecl) throws SAXException {
        reset();
        write(xmldecl);
        super.startDocument();
    }
...

    ...
    private void writeName(String uri, String localName, String qName,
        ...
        //XXX To make local/qnames work. I don't get how they're supposed to
        // be used... HNR
