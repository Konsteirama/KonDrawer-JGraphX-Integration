//=========================================================================
//
//  This file was generated by Mouse 1.6 at 2013-06-17 14:20:45 GMT
//  from grammar
//    'C:\Users\Natascha\Documents\GitHub\KonDrawer-JGraphX-Integration\teo
//    \teo\isgci\iq\iq.peg'.
//
//=========================================================================
...
public class IQParser extends mouse.runtime.ParserTest
{
  ...
  private boolean top_1()
    {
      ...
      do if (!next($Term8)) return rejectInner(top_1);
        while (!EOF());
  ...
  private boolean name()
    {
      ...
      if (!ahead('"',$Term14)) return reject(name);
      if (!next('"',$Term1)) return reject(name);
      thename();
      if (!next('"',$Term14)
       && !EOL()
         ) return reject(name);
  ...
  private boolean idstart()
    {
      ...
      if (nextIn('a','z',$Term0)) return accept(idstart);
  ...
  private boolean idchar()
    {
      ...
      if (nextIn('0','9',$Term12)) return accept(idchar);
      if (next('_',$Term13)) return accept(idchar);
  ...
  private boolean not()
    {
      ...
      if (!next("not",$Term15)) return reject(not);
  ...
  private boolean or()
    {
      ...
      if (!next("or",$Term5)) return reject(or);
  ...
  private boolean and()
    {
      ...
      if (!next("and",$Term7)) return reject(and);
  ...
  private boolean lparen()
    {
      ...
      if (!next('(',$Term2)) return reject(lparen);
      space();
  ...
  private boolean rparen()
    {
      ...
      if (!next(')',$Term18)) return reject(rparen);
      space();
  ...
  private boolean EOF()
    {
      ...
      if (!aheadNot($Term8)) return reject(EOF);
      return accept(EOF);
    }
  ...
  final Cache $Term0 = new Cache("[a-z]");
  final Cache $Term1 = new Cache("\"\"\"");
  final Cache $Term2 = new Cache("\"(\"");
  final Cache $Term3 = new Cache("[A-Z]");
  final Cache $Term4 = new Cache("[\r\n]");
  final Cache $Term5 = new Cache("\"or\"");
  final Cache $Term6 = new Cache("\"<\"");
  final Cache $Term7 = new Cache("\"and\"");
  final Cache $Term8 = new Cache("_");
  final Cache $Term9 = new Cache("\"=\"");
  final Cache $Term10 = new Cache("^[\"\r\n]");
  final Cache $Term11 = new Cache("[ \t\r\n]");
  final Cache $Term12 = new Cache("[0-9]");
  final Cache $Term13 = new Cache("\"_\"");
  final Cache $Term14 = new Cache("[\"]");
  final Cache $Term15 = new Cache("\"not\"");
